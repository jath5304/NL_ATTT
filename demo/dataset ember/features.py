...
class SectionInfo(FeatureType):
    ...
    def process_raw_features(self, raw_obj):
        ...
        # Sửa lỗi: Bỏ bớt một cặp ngoặc vuông ở 3 dòng đầu tiên

        # 1. Đặc trưng về Kích thước, Entropy, và Kích thước ảo
        section_sizes = [(s['name'], s['size']) for s in sections]
        # Đầu vào là [ [('.text', 512), ('.data', 1024)] ], một sample chứa nhiều cặp feature
        ...
        # 2. Đặc trưng về Tên và Thuộc tính của Section Entry Point
